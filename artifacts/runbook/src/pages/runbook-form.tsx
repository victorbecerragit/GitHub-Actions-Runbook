...
const EMPTY_DEFAULTS: RunbookDefaults = {
  title: "",
  system: "",
  severity: "low",
  steps: "",
    ...
    <Layout>
      <div className="flex flex-col gap-6 font-mono max-w-4xl mx-auto">
        <div className="flex items-center gap-4 border-b border-border pb-4">
          <Link
            href={isEdit ? `/runbooks/${id}` : "/"}
            className="text-muted-foreground hover:text-foreground transition-colors p-2 -ml-2 rounded-sm hover:bg-muted/50"
          >
        ...
        <Form {...form}>
          <form
            ...
            className="space-y-6 bg-card border border-border p-6 rounded-md"
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="e.g. PostgreSQL, EKS, Redis"
                        className="bg-background border-border rounded-sm font-sans"
                        {...field}
                      />
                    </FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="col-span-1 md:col-span-2">
                    <FormLabel className="text-xs uppercase tracking-wider text-muted-foreground font-bold text-red-400/80">
                      Rollback Procedure (Markdown)
                    </FormLabel>
                    <FormControl>
                      <Textarea
            ...
            <div className="flex justify-end gap-4 pt-4 border-t border-border">
              <Button
                ...
                variant="outline"
                asChild
                className="rounded-sm border-border bg-transparent hover:bg-muted/50"
              >
              ...
              <Button
                ...
                className="rounded-sm font-bold bg-primary text-primary-foreground hover:bg-primary/90"
              >
...
function EditFormLoader({ id }: { id: string }) {
  ...
  const defaults: RunbookDefaults = {
    title: runbook.title,
  ...
  return <RunbookFormInner id={id} defaults={defaults} />;
}
...
export function RunbookForm() {
  ...
  return <RunbookFormInner defaults={EMPTY_DEFAULTS} />;
}
